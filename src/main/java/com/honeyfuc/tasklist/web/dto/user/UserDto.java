package com.honeyfuc.tasklist.web.dto.user;
...
public class UserDto {
    ...
    @Schema(description = "User name", example = "Elon Musk")
    @NotNull(message = "Name must not be null.", groups = {OnCreate.class, OnUpdate.class})
    @Length(max = 255, message = "Name length must be smaller than 255 symbols", groups = {OnCreate.class, OnUpdate.class})
    private String name;

    @Schema(description = "User email", example = "handsomelon@gmail.com")
    ...
    @Schema(description = "User password", example = "twitterIsMineNow")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    @NotNull(message = "Password must not be null", groups = {OnCreate.class, OnUpdate.class})
    private String password;

    @Schema(description = "Password confirmation", example = "twitterIsMineNow")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
